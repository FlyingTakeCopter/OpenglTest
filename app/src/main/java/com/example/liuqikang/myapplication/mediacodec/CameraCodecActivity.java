package com.example.liuqikang.myapplication.mediacodec;
...
public class CameraCodecActivity extends AppCompatActivity implements View.OnClickListener, Camera.PreviewCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        surfaceViewEncode = (SurfaceView) findViewById(R.id.surfaceViewEncode);
        surfaceViewDecode = (SurfaceView) findViewById(R.id.surfaceViewDecode);
